const TimData = [
  ...
  [
    ...
    },
    {
      ...
      projectLink: "https://pogo.timothejoubert.com/",
      tagline: "Un site retraçant ma recherche autour de la typographie numérique.",
      description:
        "J'ai souhaité me réconcilier avec la typographie en la manipulant avec du code. J'ai expérimenté les possibilités qu'offrent les typographies variables afin de voir comment elles peuvent exploitées sur le web. </br></br> Dans ce projet, la typographie devient un objet purement graphique et interactif. À la manière d'un pogo, je me suis amusé à déformer, violenter, bousculer les mots pour les détourner de leur usage premier.",
      thumb: "thumb.jpg",
